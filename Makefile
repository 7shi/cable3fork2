...
#
#CWARN=
CWARN= -Wall -Wno-implicit-int -Wno-implicit-function-declaration \
	-Wno-return-type -Wno-unsequenced -Wno-shift-op-parentheses \
	-Wno-conditional-type-mismatch -Wno-parentheses \
...
# Defines
DEFS=-DKB='(kb=read(H(8),&mem[0x4a6],1))&&H(7)'

# default flags for ANSI C compilation
#
CFLAGS= ${CWARN} ${CSTD} ${ARCH} ${OPT} ${DEFS}
